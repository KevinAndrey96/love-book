        ...
        <div class="extras">
            <img src="/img/books/page2/extra/extra-1.png" class="extra modal-image1" style="z-index: 3;">
                ...
                <div class="page-wrapper" id="page21" data-order="21">
                    ...
                    <div><div id="text-page21" contenteditable="true" class="page-text large" style="position:absolute; top:170px; left: 50% !important; right: 5%; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 90% !important; font-family: 'Lato', sans-serif; z-index: 3; margin-top: 300px !important;" >
                        <div><br></div>
                ...
                <div class="page-wrapper" id="page23" data-order="23">
                    ...
                    <div><div id="text-page23" contenteditable="true" class="page-text large" style="position:absolute; top:1px !important; left: 5%; right: 5%; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 90% !important; font-family: 'Lato', sans-serif; z-index: 6;" >
                        <div><br></div>
