        ...
        <div class="row">
          <div class="col-6 col-lg-6">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="nameFemale" name="nombre" placeholder="Nombre Mujer" required>
            </div>
          </div>
          <div class="col-6 col-lg-6">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="nameMale" name="nombre" placeholder="Nombre Hombre" required>
            </div>
          </div>
        </div>
      </div>
