...
.birthday-text{
    ...
    font-family: "Bakersville";
        ...
        #text-page2{
            position:absolute; text-align:center; left: 8%;  top: 15px; right: 5%; display: flex; justify-content: center !important;  flex-direction: column; align-items:center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 6 !important;
        }

        #text-page3{
            position:absolute; text-align:center; top: 15px; left: 8%; right: 5%; display: flex; justify-content: center !important; flex-direction: column; align-items:center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 6;
        }

        #text-page4{
            position:absolute; text-align:center; top:1px !important; left: 8%; right: 5%; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 6;
        }

        #text-page5{
            position:absolute; text-align:center; top: 15px; left: 8%; right: 5%; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 6;
        }

        #text-page6{
            position:absolute; text-align:center; top:-10px; left: 8%; right: 5%; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 6;
        }
 ...
 z-index: 6;
        ...
        #text-page8{
            position:absolute; text-align:center; top:1px !important; left: 8%; right: 5%; display: flex; justify-content: center; flex-direction: column; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 6;
        }
 ...
 z-index: 6;
        ...
        #text-page10{
            position:absolute; text-align:center; top:10px !important; left: 8%; right: 5%; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 6;
        }
 ...
 z-index: 6;
        ...
        #text-page14{
            position:absolute; text-align:center; top:15px !important; left: 8%; right: 5%; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 6;        }

        #text-page15{
            position:absolute; text-align:center; top:120px !important;  left:5px; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 6;
        }
 ...
 z-index: 6;        }
        ...
        #text-page18{
            position:absolute; text-align:center; top:7px !important;   display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 6;        }
 ...
 z-index: 6;
        ...
        #text-page20{
            position:absolute; text-align:center; top:20px !important; left: 8%; right: 5%; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 6;        }

        #text-page21{
            position:absolute; text-align:center; top: 450px;  right: 150px; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important; font-family: '6ato'; z-index: 3; margin-top: 300px !important;
        }
 ...
 z-index: 3;        }
        ...
        #text-page24{
            position:absolute; text-align:center; top: 40%; left: 30%;  display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 3;        }

        #text-page25{
            position:absolute; text-align:center; top:10px !important; left: 5%; right: 5%; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 3;        }
 ...
 z-index: 3;        }
        ...
        #text-page35{
            position:absolute; text-align:center; top:1px !important; left: 10%; right: 5%; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 3;        }
 ...
 z-index: 3;        }
        ...
        #text-page39{
            position:absolute; text-align:center; top:-5px !important; left: 8%; right: 5%; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 3;        }

        #text-page40{
            position:absolute; text-align:center; top:250px !important; left: 8%; right: 5%; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 3;
        }

        #text-page41{
            position:absolute; text-align:center; top:25px !important; left: 180px !important; right: 5%; display: flex; justify-content: center; flex-direction: column; align-items: center; font-size: 60px !important;     font-family: "Bakersville";
 z-index: 3;
        }
...
<body><div class="row">
         ...
         <div class="col-12 pages">
            ...
            <div class="page-wrapper" id="first-page-wrapper">
                <img src="https://127.0.0.1:8000/img/frontpage/frontpage3/extra/two-avatars.jpg" class="page-img img-fluid" style="border: none;">
                <div class="giver-img">
                  <img src="https://127.0.0.1:8000/img/frontpage/frontpage3/woman/receiver-base.png" class="extra" style="z-index: 1;">
                  <img id="eyesfemalee2" src="https://127.0.0.1:8000/img/frontpage/frontpage3/woman/eyes/brown.png" class="extra" style="z-index: 1;">
                  <img id="hairfemalee2" src="https://127.0.0.1:8000/img/frontpage/frontpage3/woman/hair/brown/long1.png" class="extra" style="z-index: 1;">
                  <img id="glassesfemalee2" src="https://127.0.0.1:8000/img/frontpage/frontpage3/woman/glasses/glasses.png" class="extra" style="z-index: 2; display: none;">
                </div>
                <div class="receiver-img">
                  <img src="https://127.0.0.1:8000/img/frontpage/frontpage3/man/giver-base.png" class="extra" style="z-index: 2;">
                  <img id="eyesmalee2" src="https://127.0.0.1:8000/img/frontpage/frontpage3/man/eyes/brown.png" class="extra" style="z-index: 2;">
                  <img id="hairmalee2" src="https://127.0.0.1:8000/img/frontpage/frontpage3/man/hair/brown/half1.png" class="extra" style="z-index: 2;">
                  <img id="beardd2" src="https://127.0.0.1:8000/img/frontpage/frontpage3/man/beard/brown/brown1.png" class="extra" style="z-index: 2; display: block;">
                  <img id="glassesmalee2" src="https://127.0.0.1:8000/img/frontpage/frontpage3/man/glasses/glasses.png" class="extra" style="z-index: 2; display: none;">
                </div>
                <div class="extras">
                  <img src="https://127.0.0.1:8000/img/frontpage/frontpage3/extra/extra-1.png" class="extra" onclick="selectContainerContent('frontpage3')" style="z-index: 3;">
                </div>
                <div class="tittle-wrapper text d-flex flex-column" style="z-index: 100;">
                    <span class="birthday-text" style="display: block;">HAPPY BIRTHDAY</span>

                    <h3 id="names2" title="Esta será tu portada"> sa &amp; as</h3>
    ...
    <div class="page-wrapper" id="page2" data-order="2">
        ...
        <div class="giver-img">
            ...
            <img id="glassesfemale2" src="https://127.0.0.1:8000/img/books/page2/woman/glasses/glasses.png" class="extra modal-image1" style="z-index: 1; display: none;">
        </div>
        <div class="receiver-img">
            <img src="https://127.0.0.1:8000/img/books/page2/man/receiver-base.png" class="extra modal-image1" style="z-index: 2;">
            <img id="eyesmale2" src="https://127.0.0.1:8000/img/books/page2/man/eyes/brown.png" class="extra modal-image1" style="z-index: 2;">
            <img id="hairmale2" src="https://127.0.0.1:8000/img/books/page2/man/hair/brown/half1.png" class="extra modal-image1" style="z-index: 2;">
        ...
        <div>
            <div id="text-page2" contenteditable="true" class="page-text large">
                ...
                <div class="receiver-img">
                    ...
                    <img id="hairmale3" src="https://127.0.0.1:8000/img/books/page3/man/hair/brown/half1.png" class="extra modal-image3" style="z-index: 1;">
                ...
                <div class="receiver-img">
                    ...
                    <img id="hairmale4" src="https://127.0.0.1:8000/img/books/page4/man/hair/brown/half1.png" class="extra modal-image4" style="z-index: 2;">
                ...
                <div class="receiver-img">
                    ...
                    <img id="hairmale6" src="https://127.0.0.1:8000/img/books/page6/man/hair/brown/half1.png" class="extra modal-image6" style="z-index: 2;">
                ...
                <div class="page-wrapper" id="page8" data-order="8">
                    ...
                    <div class="receiver-img">
                        ...
                        <img id="hairmale8" src="https://127.0.0.1:8000/img/books/page8/man/hair/brown/half1.png" class="extra modal-image8" style="z-index: 2;">
                ...
                <div class="page-wrapper" id="page10" data-order="10">
                    ...
                    <div class="giver-img">
                        ...
                        <img id="hairmale10" src="https://127.0.0.1:8000/img/books/page10/man/hair/brown/half1.png" class="extra modal-image10" style="z-index: 1;">
                ...
                <div class="page-wrapper" id="page14" data-order="14">
                    ...
                    <div class="receiver-img">
                        ...
                        <img id="hairmale14" src="https://127.0.0.1:8000/img/books/page14/man/hair/brown/half1.png" class="extra modal-image14" style="z-index: 2;">
                ...
                <div class="page-wrapper" id="page16" data-order="16">
                    ...
                    <div class="giver-img">
                        ...
                        <img id="hairmale16" src="https://127.0.0.1:8000/img/books/page16/man/hair/brown/half1.png" class="extra modal-image16" style="z-index: 1;">
                ...
                <div class="page-wrapper" id="page18" data-order="18">
                    ...
                    <div class="receiver-img">
                        ...
                        <img id="hairmale18" src="https://127.0.0.1:8000/img/books/page18/man/hair/brown/half1.png" class="extra modal-image18" style="z-index: 1;">
                ...
                <div class="page-wrapper" id="page21" data-order="21">
                    ...
                    <div class="receiver-img">
                        ...
                        <img id="hairmale21" src="https://127.0.0.1:8000/img/books/page21/man/hair/brown/half1.png" class="extra modal-image21" style="z-index: 2;">
                ...
                <div class="page-wrapper" id="page32" data-order="32">
                    ...
                    <div class="giver-img">
                        ...
                        <img id="hairmale32" src="https://127.0.0.1:8000/img/books/page32/man/hair/brown/half1.png" class="extra modal-image32" style="z-index: 1;">
                ...
                <div class="page-wrapper" id="page39" data-order="39">
                    ...
                    <div class="giver-img">
                        ...
                        <img id="hairmale39" src="https://127.0.0.1:8000/img/books/page39/man/hair/brown/half1.png" class="extra modal-image39" style="z-index: 2;">
                ...
                <div class="page-wrapper" id="page23" data-order="23">
                    ...
                    <div class="receiver-img">
                        ...
                        <img id="hairmale23" src="https://127.0.0.1:8000/img/books/page23/man/hair/brown/half1.png" class="extra modal-image23" style="z-index: 2;">
                ...
                <div class="receiver-img">
                    ...
                    <img id="hairmale45" src="https://127.0.0.1:8000/img/books/page45/man/hair/brown/half1.png" class="extra modal-image45" style="z-index: 2;">
              ...
              <div class="page-wrapper logo">
                <div class="Logo-container" id="logo">
                    <img src="https://127.0.0.1:8000/img/LDALogo.png">
                </div>
            </div>
     ...
     <script src="http://127.0.0.1:8000/js/Book_front_page.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page1.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page2.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page3.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page4.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page6.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page7.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page8.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page10.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page14.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page16.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page18.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page21.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page23.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page26.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page32.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page37.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page39.js"></script>
     <script src="http://127.0.0.1:8000/js/Books_pages_page45.js"></script>
