...
var eyesmale = document.getElementById("eyesmale21");
var eyesfemale = document.getElementById("eyesfemale21");
var hairmale = document.getElementById("hairmale21");
var hairfemale = document.getElementById("hairfemale21");
var glassesmale = document.getElementById("glassesmale21");
var glassesfemale = document.getElementById("glassesfemale21");
var beard = document.getElementById("beardmale21");

// Establecer la ruta de la imagen de las gafas para hombres y mujeres

var glassesFemalePath = "/Images/Books/Page-21/Woman/Glasses/glasses.png";
var glassesMalePath = "/Images/Books/Page-21/Man/Glasses/glasses.png";
...
// Obtener las dos últimas partes de la ruta que contiene el tipo y color de los ojos para hombres y mujeres
  ...
  var eyesMale = "/Images/Books/Page-21/Man/Eyes" + eyesColorSuffixMale;
  var eyesFemale = "/Images/Books/Page-21/Woman/Eyes" + eyesColorSuffixFemale;
  var hairMale = "/Images/Books/Page-21/Man/Hair/" + hairColorMan + "/" + hairTypeMan + ".png";
  var hairFemale = "/Images/Books/Page-21/Woman/Hair/" + hairColorWoman + "/" + hairTypeWoman + ".png";
  ...
  if (beardDisplay === "none") {
    ...
    var beardColor = beardParts[beardParts.length - 2];
    var beardType = beardParts[beardParts.length - 1].split(".")[0];
    var beardMale = "/Images/Books/Page-21/Man/Beard/" + beardColor + "/" + beardType + ".png";
