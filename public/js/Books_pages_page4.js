...
var eyesmale = document.getElementById("eyesmale4");
var eyesfemale = document.getElementById("eyesfemale4");
var hairmale = document.getElementById("hairmale4");
var hairfemale = document.getElementById("hairfemale4");
var glassesmale = document.getElementById("glassesmale4");
var glassesfemale = document.getElementById("glassesfemale4");
var beard = document.getElementById("beardmale4");

// Establecer la ruta de la imagen de las gafas para hombres y mujeres

var glassesFemalePath = "/Images/Books/Page-4/Woman/Glasses/glasses.png";
var glassesMalePath = "/Images/Books/Page-4/Man/Glasses/glasses.png";
...
// Obtener las dos últimas partes de la ruta que contiene el tipo y color de los ojos para hombres y mujeres
  ...
  var eyesMale = "/Images/Books/Page-4/Man/Eyes" + eyesColorSuffixMale;
  var eyesFemale = "/Images/Books/Page-4/Woman/Eyes" + eyesColorSuffixFemale;
  var hairMale = "/Images/Books/Page-4/Man/Hair/" + hairColorMan + "/" + hairTypeMan + ".png";
  var hairFemale = "/Images/Books/Page-4/Woman/Hair/" + hairColorWoman + "/" + hairTypeWoman + ".png";
  ...
  if (beardDisplay === "none") {
    ...
    var beardColor = beardParts[beardParts.length - 2];
    var beardType = beardParts[beardParts.length - 1].split(".")[0];
    var beardMale = "/Images/Books/Page-4/Man/Beard/" + beardColor + "/" + beardType + ".png";
