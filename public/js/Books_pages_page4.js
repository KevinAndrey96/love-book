...
var glassesFemalePath = "/images/books/page4/woman/glasses/glasses.png";
var glassesMalePath = "/images/books/page4/man/glasses/glasses.png";
...
// Obtener las dos últimas partes de la ruta que contiene el tipo y color de los ojos para hombres y mujeres
  ...
  var eyesMale = "/images/books/page4/man/eyes" + eyesColorSuffixMale;
  var eyesFemale = "/images/books/page4/woman/eyes" + eyesColorSuffixFemale;
  var hairMale = "/images/books/page4/man/hair/" + hairColorMan + "/" + hairTypeMan + ".png";
  var hairFemale = "/images/books/page4/woman/hair/" + hairColorWoman + "/" + hairTypeWoman + ".png";
  ...
  if (beardDisplay === "none") {
    ...
    var beardColor = beardParts[beardParts.length - 2];
    var beardType = beardParts[beardParts.length - 1].split(".")[0];
    var beardMale = "/images/books/page4/man/beard/" + beardColor + "/" + beardType + ".png";
