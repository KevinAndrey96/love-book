...
var glassesFemalePath = "/img/books/page4/woman/glasses/glasses.png";
var glassesMalePath = "/img/books/page4/man/glasses/glasses.png";
...
// Obtener las dos últimas partes de la ruta que contiene el tipo y color de los ojos para hombres y mujeres
  ...
  var eyesMale = "/img/books/page4/man/eyes" + eyesColorSuffixMale;
  var eyesFemale = "/img/books/page4/woman/eyes" + eyesColorSuffixFemale;
  var hairMale = "/img/books/page4/man/hair/" + hairColorMan + "/" + hairTypeMan + ".png";
  var hairFemale = "/img/books/page4/woman/hair/" + hairColorWoman + "/" + hairTypeWoman + ".png";
  ...
  if (beardDisplay === "none") {
    ...
    var beardColor = beardParts[beardParts.length - 2];
    var beardType = beardParts[beardParts.length - 1].split(".")[0];
    var beardMale = "/img/books/page4/man/beard/" + beardColor + "/" + beardType + ".png";
