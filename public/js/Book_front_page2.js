...
var eyesmale = document.getElementById("eyesmale1");
var eyesfemale = document.getElementById("eyesfemale1");
var hairmale = document.getElementById("hairmale1");
var hairfemale = document.getElementById("hairfemale1");
var glassesmale = document.getElementById("glassesmale1");
var glassesfemale = document.getElementById("glassesfemale1");
var beard = document.getElementById("beard1");
var titleElement = document.getElementById('names1');


// Establecer la ruta de la imagen de las gafas para hombres y mujeres

var glassesFemalePath = "/img/frontpage/frontpage2/woman/glasses/glasses.png";
var glassesMalePath = "/img/frontpage/frontpage2/man/glasses/glasses.png";
...
// Obtener las dos últimas partes de la ruta que contiene el tipo y color de los ojos para hombres y mujeres
  ...
  var eyesMale = "/img/frontpage/frontpage2/man/eyes" + eyesColorSuffixMale;
  var eyesFemale = "/img/frontpage/frontpage2/woman/eyes" + eyesColorSuffixFemale;
  var hairMale = "/img/frontpage/frontpage2/man/hair/" + hairColorMan + "/" + hairTypeMan + ".png";
  var hairFemale = "/img/frontpage/frontpage2/woman/hair/" + hairColorWoman + "/" + hairTypeWoman + ".png";
  ...
  if (beardDisplay === "none") {
    ...
    var beardColor = beardParts[beardParts.length - 2];
    var beardType = beardParts[beardParts.length - 1].split(".")[0];
    var beardMale = "/img/frontpage/frontpage2/man/beard/" + beardColor + "/" + beardType + ".png";
