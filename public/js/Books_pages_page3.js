...
var eyesmale = document.getElementById("eyesmale3");
var eyesfemale = document.getElementById("eyesfemale3");
var hairmale = document.getElementById("hairmale3");
var hairfemale = document.getElementById("hairfemale3");
var glassesmale = document.getElementById("glassesmale3");
var glassesfemale = document.getElementById("glassesfemale3");
var beard = document.getElementById("beardmale3");

// Establecer la ruta de la imagen de las gafas para hombres y mujeres

var glassesFemalePath = "/img/books/page3/woman/glasses/glasses.png";
var glassesMalePath = "/img/books/page3/man/glasses/glasses.png";
var glassesFemalePathShort = "/img/books/page3/woman/glasses/glasses2.png";
...
// Obtener las dos últimas partes de la ruta que contiene el tipo y color de los ojos para hombres y mujeres
  ...
  var eyesMale = "/img/books/page3/man/eyes" + eyesColorSuffixMale;
  var eyesFemale = "/img/books/page3/woman/eyes" + eyesColorSuffixFemale;
  var hairMale = "/img/books/page3/man/hair/" + hairColorMan + "/" + hairTypeMan + ".png";
  var hairFemale = "/img/books/page3/woman/hair/" + hairColorWoman + "/" + hairTypeWoman + ".png";
  ...
  if (beardDisplay === "none") {
    ...
    var beardColor = beardParts[beardParts.length - 2];
    var beardType = beardParts[beardParts.length - 1].split(".")[0];
    var beardMale = "/img/books/page3/man/beard/" + beardColor + "/" + beardType + ".png";
