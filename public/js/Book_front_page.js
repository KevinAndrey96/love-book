...
var glassesFemalePath = "/img/frontpage/woman/glasses/glasses.png";
var glassesMalePath = "/img/frontpage/man/glasses/glasses.png";
...
// Obtener las dos últimas partes de la ruta que contiene el tipo y color de los ojos para hombres y mujeres
  ...
  var eyesMale = "/img/frontpage/man/eyes" + eyesColorSuffixMale;
  var eyesFemale = "/img/frontpage/woman/eyes" + eyesColorSuffixFemale;
  var hairMale = "/img/frontpage/man/hair/" + hairColorMan + "/" + hairTypeMan + ".png";
  var hairFemale = "/img/frontpage/woman/hair/" + hairColorWoman + "/" + hairTypeWoman + ".png";
  ...
  if (beardDisplay === "none") {
    ...
    var beardColor = beardParts[beardParts.length - 2];
    var beardType = beardParts[beardParts.length - 1].split(".")[0];
    var beardMale = "/img/frontpage/man/beard/" + beardColor + "/" + beardType + ".png";
