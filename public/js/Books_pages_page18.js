...
var glassesFemalePath = "/images/books/page18/woman/glasses/glasses.png";
var glassesMalePath = "/images/books/page18/man/glasses/glasses.png";
...
// Obtener las dos últimas partes de la ruta que contiene el tipo y color de los ojos para hombres y mujeres
  ...
  var eyesMale = "/images/books/page18/man/eyes" + eyesColorSuffixMale;
  var eyesFemale = "/images/books/page18/woman/eyes" + eyesColorSuffixFemale;
  var hairMale = "/images/books/page18/man/hair/" + hairColorMan + "/" + hairTypeMan + ".png";
  var hairFemale = "/images/books/page18/woman/hair/" + hairColorWoman + "/" + hairTypeWoman + ".png";
  ...
  if (beardDisplay === "none") {
    ...
    var beardColor = beardParts[beardParts.length - 2];
    var beardType = beardParts[beardParts.length - 1].split(".")[0];
    var beardMale = "/images/books/page18/man/beard/" + beardColor + "/" + beardType + ".png";
