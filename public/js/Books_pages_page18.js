...
var eyesmale = document.getElementById("eyesmale18");
var eyesfemale = document.getElementById("eyesfemale18");
var hairmale = document.getElementById("hairmale18");
var hairfemale = document.getElementById("hairfemale18");
var glassesmale = document.getElementById("glassesmale18");
var glassesfemale = document.getElementById("glassesfemale18");
var beard = document.getElementById("beardmale18");

// Establecer la ruta de la imagen de las gafas para hombres y mujeres

var glassesFemalePath = "/img/books/page18/woman/glasses/glasses.png";
var glassesMalePath = "/img/books/page18/man/glasses/glasses.png";
var glassesFemalePathShort = "/img/books/page18/woman/glasses/glasses2.png";
...
// Obtener las dos últimas partes de la ruta que contiene el tipo y color de los ojos para hombres y mujeres
  ...
  var eyesMale = "/img/books/page18/man/eyes" + eyesColorSuffixMale;
  var eyesFemale = "/img/books/page18/woman/eyes" + eyesColorSuffixFemale;
  var hairMale = "/img/books/page18/man/hair/" + hairColorMan + "/" + hairTypeMan + ".png";
  var hairFemale = "/img/books/page18/woman/hair/" + hairColorWoman + "/" + hairTypeWoman + ".png";
  ...
  if (beardDisplay === "none") {
    ...
    var beardColor = beardParts[beardParts.length - 2];
    var beardType = beardParts[beardParts.length - 1].split(".")[0];
    var beardMale = "/img/books/page18/man/beard/" + beardColor + "/" + beardType + ".png";
