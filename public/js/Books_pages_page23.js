...
var eyesmale = document.getElementById("eyesmale23");
var eyesfemale = document.getElementById("eyesfemale23");
var hairmale = document.getElementById("hairmale23");
var hairfemale = document.getElementById("hairfemale23");
var glassesmale = document.getElementById("glassesmale23");
var glassesfemale = document.getElementById("glassesfemale23");
var beard = document.getElementById("beardmale23");

// Establecer la ruta de la imagen de las gafas para hombres y mujeres

var glassesFemalePath = "/img/books/page23/woman/glasses/glasses.png";
var glassesMalePath = "/img/books/page23/man/glasses/glasses.png";
...
// Obtener las dos últimas partes de la ruta que contiene el tipo y color de los ojos para hombres y mujeres
  ...
  var eyesMale = "/img/books/page23/man/eyes" + eyesColorSuffixMale;
  var eyesFemale = "/img/books/page23/woman/eyes" + eyesColorSuffixFemale;
  var hairMale = "/img/books/page23/man/hair/" + hairColorMan + "/" + hairTypeMan + ".png";
  var hairFemale = "/img/books/page23/woman/hair/" + hairColorWoman + "/" + hairTypeWoman + ".png";
  ...
  if (beardDisplay === "none") {
    ...
    var beardColor = beardParts[beardParts.length - 2];
    var beardType = beardParts[beardParts.length - 1].split(".")[0];
    var beardMale = "/img/books/page23/man/beard/" + beardColor + "/" + beardType + ".png";
