...
var eyesmale = document.getElementById("eyesmale14");
var eyesfemale = document.getElementById("eyesfemale14");
var hairmale = document.getElementById("hairmale14");
var hairfemale = document.getElementById("hairfemale14");
var glassesmale = document.getElementById("glassesmale14");
var glassesfemale = document.getElementById("glassesfemale14");
var beard = document.getElementById("beardmale14");

// Establecer la ruta de la imagen de las gafas para hombres y mujeres

var glassesFemalePath = "/img/books/page14/woman/glasses/glasses.png";
var glassesMalePath = "/img/books/page14/man/glasses/glasses.png";
var glassesFemalePathShort = "/img/books/page14/woman/glasses/glasses2.png"; // Nueva ruta para gafas2
...
// Obtener las dos últimas partes de la ruta que contiene el tipo y color de los ojos para hombres y mujeres
  ...
  var eyesMale = "/img/books/page14/man/eyes" + eyesColorSuffixMale;
  var eyesFemale = "/img/books/page14/woman/eyes" + eyesColorSuffixFemale;
  var hairMale = "/img/books/page14/man/hair/" + hairColorMan + "/" + hairTypeMan + ".png";
  var hairFemale = "/img/books/page14/woman/hair/" + hairColorWoman + "/" + hairTypeWoman + ".png";
  ...
  if (beardDisplay === "none") {
    ...
    var beardColor = beardParts[beardParts.length - 2];
    var beardType = beardParts[beardParts.length - 1].split(".")[0];
    var beardMale = "/img/books/page14/man/beard/" + beardColor + "/" + beardType + ".png";
