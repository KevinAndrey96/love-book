...
var eyesmale = document.getElementById("eyesmale32");
var eyesfemale = document.getElementById("eyesfemale32");
var hairmale = document.getElementById("hairmale32");
var hairfemale = document.getElementById("hairfemale32");
var glassesmale = document.getElementById("glassesmale32");
var glassesfemale = document.getElementById("glassesfemale32");
var beard = document.getElementById("beardmale32");

// Establecer la ruta de la imagen de las gafas para hombres y mujeres

var glassesFemalePath = "/img/books/page32/woman/glasses/glasses.png";
var glassesMalePath = "/img/books/page32/man/glasses/glasses.png";
var glassesFemalePathShort = "/img/books/page32/woman/glasses/glasses2.png";
...
// Obtener las dos últimas partes de la ruta que contiene el tipo y color de los ojos para hombres y mujeres
  ...
  var eyesMale = "/img/books/page32/man/eyes" + eyesColorSuffixMale;
  var eyesFemale = "/img/books/page32/woman/eyes" + eyesColorSuffixFemale;
  var hairMale = "/img/books/page32/man/hair/" + hairColorMan + "/" + hairTypeMan + ".png";
  var hairFemale = "/img/books/page32/woman/hair/" + hairColorWoman + "/" + hairTypeWoman + ".png";
  ...
  if (beardDisplay === "none") {
    ...
    var beardColor = beardParts[beardParts.length - 2];
    var beardType = beardParts[beardParts.length - 1].split(".")[0];
    var beardMale = "/img/books/page32/man/beard/" + beardColor + "/" + beardType + ".png";
