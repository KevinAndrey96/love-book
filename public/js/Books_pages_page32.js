...
var glassesFemalePath = "/Images/Books/Page-32/Woman/Glasses/glasses.png";
var glassesMalePath = "/Images/Books/Page-32/Man/Glasses/glasses.png";
...
// Obtener las dos últimas partes de la ruta que contiene el tipo y color de los ojos para hombres y mujeres
  ...
  var eyesMale = "/Images/Books/Page-32/Man/Eyes" + eyesColorSuffixMale;
  var eyesFemale = "/Images/Books/Page-32/Woman/Eyes" + eyesColorSuffixFemale;
  var hairMale = "/Images/Books/Page-32/Man/Hair/" + hairColorMan + "/" + hairTypeMan + ".png";
  var hairFemale = "/Images/Books/Page-32/Woman/Hair/" + hairColorWoman + "/" + hairTypeWoman + ".png";
  ...
  if (beardDisplay === "none") {
    ...
    var beardColor = beardParts[beardParts.length - 2];
    var beardType = beardParts[beardParts.length - 1].split(".")[0];
    var beardMale = "/Images/Books/Page-32/Man/Beard/" + beardColor + "/" + beardType + ".png";
