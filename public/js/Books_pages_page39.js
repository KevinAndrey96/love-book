...
var glassesMalePath = "/img/books/page39/man/glasses/glasses.png";
...
// Obtener las dos últimas partes de la ruta que contiene el tipo y color de los ojos para hombres y mujeres
  ...
  var eyesMale = "/img/books/page39/man/eyes" + eyesColorSuffixMale;
  var hairMale = "/img/books/page39/man/hair/" + hairColorMan + "/" + hairTypeMan + ".png";
  ...
  if (beardDisplay === "none") {
    ...
    var beardColor = beardParts[beardParts.length - 2];
    var beardType = beardParts[beardParts.length - 1].split(".")[0];
    var beardMale = "/img/books/page39/man/beard/" + beardColor + "/" + beardType + ".png";
