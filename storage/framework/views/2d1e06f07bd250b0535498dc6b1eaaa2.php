...
<head>
    ...
    <link rel="stylesheet" href ="<?php echo e(asset('css/Book_front_page.css')); ?>">
              ...
              <div class="page-wrapper" id="frontpage3">
                ...
                <div class="page-wrapper" id="frontpage4">
                    ...
                    <div class="receiver-img">
                      ...
                      <img id="eyesmalee3" src="/img/frontpage/frontpage4/man/eyes/brown.png" class="extra" style="z-index: 2;">
                      <img id="hairmalee3" src="/img/frontpage/frontpage4/man/hair/brown/half1.png" class="extra" style="z-index: 2;">
                      <img id="beardd3" src="/img/frontpage/frontpage4/man/beard/brown/brown1.png" class="extra" style="z-index: 2; " onclick="selectContainerContent('frontpage4')">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="btn-group btn-group-lg d-flex" role="group">
                            ...
                            <a href="<?php echo e(url('avatar-female')); ?>" class="btn btn-primary flex-fill" id="btn2">Cambia la apariencia de la mujer</a>
                            <a href="<?php echo e(url('avatar-male')); ?>" class="btn btn-primary flex-fill" id="btn3">Cambia la apariencia del hombre</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="<?php echo e(asset('js/Book_front_page1.js')); ?>"></script>
<script src="<?php echo e(asset('js/Book_front_page2.js')); ?>"></script>
<script src="<?php echo e(asset('js/Book_front_page3.js')); ?>"></script>
<script src="<?php echo e(asset('js/Book_front_page4.js')); ?>"></script>

</body>
</html>
<?php /**PATH C:\xampp\htdocs\Love-Book\resources\views/Books/Book_front_page.blade.php ENDPATH**/ ?>