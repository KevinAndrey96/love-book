...
<div class="container">
    <div class="row">
        <div class="col-sm-8 col-xs-12">
            <a href="<?php echo e(url('books-pages')); ?>" class="btn1 btn-block" id="btn1">Personaliza las páginas de tu libro</a>
        </div>
        <div class="col-sm-8 col-xs-12">
            <a href="<?php echo e(url('avatar-female')); ?>" class="btn1 btn-block" id="btn2">Cambia la apariencia de la mujer</a>
        </div>
        <div class="col-sm-8 col-xs-12">
            <a href="<?php echo e(url('avatar-male')); ?>" class="btn1 btn-block" id="btn3">Cambia la apariencia del hombre</a>
        </div>
    </div>
</div>
</div>
